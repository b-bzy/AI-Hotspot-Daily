...
每天从 14 个中英文信息源抓取过去 24 小时的 AI 热点，由 Claude Code 整理成一份分类日报。零 API 成本：抓取脚本纯 Python 标准库（零依赖），所有信息源均为免费匿名接口，整理跑在 Claude Code 定时任务里。

## 信息源（全部实测可用）

**英文**：Hacker News（Algolia API）· HuggingFace Daily Papers / Trending · GitHub Trending · Techmeme · smol.ai AINews（X/Reddit/Discord 每日综述）· zpravobot（@sama/@OpenAI/@AnthropicAI 等推文镜像）

**中文**：微博热搜 · 知乎热榜 · B站排行 · 量子位 · IT之家 · 36氪 · 掘金 AI 热榜
